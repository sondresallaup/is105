...
gruppe = {  'student1': 'Marius Olsen', \
			'student2': 'Emil Ry', \
            'student3': 'Sondre Sallaup', \
}
...
def card_ranks(hand):
	...
	scoreArray = []
	for currentHand in hand:
		currentHand
		if(currentHand[0] == 'T'):
			scoreArray.append(10)
		elif(currentHand[0] == 'J'):
			scoreArray.append(11)
		elif(currentHand[0] == 'Q'):
			scoreArray.append(12)
		elif(currentHand[0] == 'K'):
			scoreArray.append(13)
		else:
			scoreArray.append(int(currentHand[0]))
	return scoreArray
...
def test():
	...
	st = "1C 2D 3C 4C 5D".split() # Sraigth
	tp = "3D 3H 6S 6C 7D".split() # Two pairs
	...
	straightMot100FullArray = [100]
	straightMot100FullArray[0] = sf
	for i in range(1, 100):
		straightMot100FullArray.append(fh)

	assert poker(straightMot100FullArray)

	#assert poker([]) ikke lov uten innhold
	...
	assert card_ranks(st) == [1,2,3,4,5]
	assert card_ranks(tp) == [3,3,6,6,7]
